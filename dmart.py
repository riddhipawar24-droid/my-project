class dmart:
    def _inti_(self,category,product_name,qty,price):
    ...
    def display_store_details(cls):
        return f"store_name -->{cls.storename}"

    def common_features(self):
        return f"categroy:{self.category}\nproduct_name:(self.product_name)\nqty:(self.qty)\nprice(self.price)"



  from dmart import dmart
class grocery(dmart):
    def _inti_(self, category, product_name, qty, price,brand_name,mfg,exp):
        super()._inti_(category, product_name, qty, price)
